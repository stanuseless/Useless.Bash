...
`0.5.1-UNSTABLE`
| [GitHub](https://github.com/stanuseless/Useless.Bash/releases/tag/0.5.1-UNSTABLE)
...
$ ./assemble.sh 'unstable' \
 ...
 && unzip -d /opt/Useless.Bash-0.5.1-UNSTABLE ./build/zip/Useless.Bash-0.5.1-UNSTABLE.zip
```
...
```
$ TMP_PATH="$(mktemp)"; \
 curl -L 'https://github.com/stanuseless/Useless.Bash/releases/download/0.5.1-UNSTABLE/Useless.Bash-0.5.1-UNSTABLE.zip' \
  -o "${TMP_PATH}" && unzip -d /opt/Useless.Bash-0.5.1-UNSTABLE "${TMP_PATH}" && rm "${TMP_PATH}"
```
